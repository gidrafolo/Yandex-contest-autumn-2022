class Recipe:
    __count_ingred: int
    __list_of_ingred: list[int]

    def __init__(self, count_ingred, list_of_ingred):
        self.__count_ingred = count_ingred
        self.__list_of_ingred = list_of_ingred

    @property
    def count_ingred(self):
        return self.__count_ingred

    @property
    def list_of_ingred(self):
        return self.__list_of_ingred
...
class ValidatedRecipe(Recipe):
    ...
    def __init__(self, recipe: Recipe, allCountA: int, allCountB: int, isValid: bool):
        ...
        self.__allCountA = allCountA
        self.__allCountB = allCountB
        self.__isValid = isValid

    @property
    def allCountA(self):
        return self.__allCountA

    @allCountA.setter
    def allCountA(self, value):
        self._allCountA = value

    @property
    def allCountB(self):
        return self.__allCountB

    @allCountB.setter
    def allCountB(self, value):
        self._allCountB = value
...
class Question:
    ...
    def __init__(self, count_A, count_B, potion_number):
        self.__count_A = count_A
        self.__count_B = count_B
        self.__potion_number = potion_number
    ...
    @property
    def potion_number(self):
        return self.__potion_number
